...
CommonJS — простая и удобная система управления зависимостями, а доступ к практически безграничным ресурсам NPM открывает потрясающие возможности для быстрой и качественной разработки.

Я надеюсь, что разработчики модулей в скором времени начнут уделять больше внимания поддержке CommonJS в своих проектах, ведь в этом нет ничего сложного, а работать с CommonJS даже проще, чем с AMD. 

Нет никаких причин, чтобы не использовать CommonJS прямо сейчас.
