...
За этот месяц я наконец-то хоть как-то разобрался с [юнит-тестами][6], узнал, как
создавать [CLI с помощью NodeJS][7], наконец-то [отрефакторил свой блог][8], написал
плагин для [GruntJS][9], пару переводов во [Frontender Magazine][4]. Кроме того, я
